...
const USED = [
  'brain', 'image-outline', 'restart', 'radar', 'chevron-right', 'heart-pulse',
  'download', 'close', 'lock-open-variant-outline', 'shield-key-outline',
  'alert-octagon-outline', 'check-decagram-outline', 'lock-outline', 'key-variant',
  'check-circle', 'pulse', 'chevron-left', 'access-point', 'timer-sand',
  'format-list-numbered', 'chart-bell-curve-cumulative', 'power', 'radar',
]
